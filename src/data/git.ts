...
export const Git = [
  ...
  [
    `Работа с SSH ключем`,
    `<b>ssh-keygen -t rsa -b 4096 -C "email"</b> - создание ключа где email является меткой<br>
    <b>eval "$(ssh-agent -s)"</b> - запуск SSH агента<br>
    <b>ssh-add -K /Users/you/.ssh/id_rsa</b> - добавление созданного ключа в агент`
  ],
  [
